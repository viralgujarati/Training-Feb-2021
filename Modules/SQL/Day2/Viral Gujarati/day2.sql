...
/* Write a SQL statement to change the Email and CommissionPct column of employees table with not available and 0.10 for those employees 
whose DepartmentID is 110. */
UPDATE Employees SET Email='not available', CommissionPct= .10 WHERE DepartmentID=110

/* Write a SQL statement to change the Email column of employees table with not available for those employees whose DepartmentID is 80 and 
...
/* Write a SQL statement to change job ID of employee which ID is 118, to SH_CLERK if the employee belongs to department, which ID is 30 and 
